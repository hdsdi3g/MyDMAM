...
class RequestHandlerRegisterStore extends RequestHandler<RegisterStoreMessage> {
	...
	public void onRequest(DataBlock block, Node source_node) {
		...
		pipeline.onExternalRegisterStore(RegisterStoreMessage.fromJson(block.getJsonDatas()), source_node);
	}
	
	@Override
	public DataBlock createRequest(RegisterStoreMessage options) {
