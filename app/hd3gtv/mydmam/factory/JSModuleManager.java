...
public final class JSModuleManager {
	 ...
	 * @return created file
	 */
	public static File createEmptyJSDefinition(Class<?> interface_to_implements, String new_module_name) throws IOException {
		...
		Arrays.asList(interface_to_implements.getMethods()).forEach(method -> {
			...
			String funct_param = Arrays.asList(method.getParameterTypes()).stream().map(param -> {
				String mtd = "";
				if (param.isEnum()) {
					mtd = " Enum";
