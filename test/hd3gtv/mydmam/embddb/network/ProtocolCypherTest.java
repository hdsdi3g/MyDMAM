...
public class ProtocolCypherTest extends TestCase {
	...
	// XXX mergue Keystoretool tests...
	
	public void testNormal() throws IOException, GeneralSecurityException, SecurityException, OperatorCreationException {
	...
	public void testNormal2() throws IOException, GeneralSecurityException, SecurityException, OperatorCreationException {
		Protocol p = new Protocol("ThisIsAPassword");
		byte[] result = p.encrypt(source);
		p = null;
	...
	public void testNotSamePassword() throws IOException, GeneralSecurityException, SecurityException, OperatorCreationException {
	...
	public void testBadPassword() throws IOException, SecurityException, OperatorCreationException, GeneralSecurityException {
