	...
	render: function(){
		...
		for (user_key in userlist) {
			...
			items.push(React.createElement("tr", {key: user_key}, 
				...
				React.createElement("td", null, 
					user.language, " • ", React.createElement("small", null, React.createElement("a", {href: "mailto:" + user.email_addr}, user.email_addr))
				), 
				React.createElement("td", null, 
				...
				React.createElement("td", null, 
					React.createElement("small", null, toList(user.user_groups))
				), 
				React.createElement("td", null, 
			...
			React.createElement("table", {className: "table table-bordered table-striped table-condensed"}, 
				React.createElement("thead", null, 
					React.createElement("tr", null, 
						...
						React.createElement("th", null, i18n("auth.lang"), " • ", i18n("auth.email")), 
			...
			React.createElement(mydmam.async.PageHeaderTitle, {title: i18n("auth.usercreate"), fluid: "false"}, 
				React.createElement("form", {className: "form-horizontal", onSubmit: this.onAddBtnClick}, 
					...
					React.createElement(FormControlGroup, {label: i18n("auth.password")}, 
						...
						React.createElement("span", {className: "help-block"}, i18n("auth.password-hint"))
					), 
		...
		return (
			React.createElement(mydmam.async.PageHeaderTitle, {title: i18n("auth.userupdate", user.fullname), fluid: "false"}, 
				React.createElement("form", {className: "form-horizontal", onSubmit: this.onUpdBtnClick}, 
					React.createElement(FormControlGroup, {label: i18n("auth.remove-label")}, 
						React.createElement("a", {className: "btn btn-danger", onClick: this.onDeleteBtnClick}, React.createElement("i", {className: "icon-remove icon-white"}), " ", i18n("auth.remove"))
					), 
...
// Source hash: 172a8a1a393f8a5f14168c78b82b3fdb
