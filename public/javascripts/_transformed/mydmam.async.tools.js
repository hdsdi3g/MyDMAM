...
async.CheckboxItem = React.createClass({displayName: "CheckboxItem",
	propTypes: {
	...
	render: function() {
		return (
			React.createElement("label", {className: "checkbox"}, 
	        	React.createElement("input", {type: "checkbox", ref: "cb", defaultChecked: this.props.checked, onChange: this.onClickCB}), " ", this.props.children
			)
		);
	}
});
...
// Source hash: 7270959b0001fc3f7be0856d1add2a56
