			...
			if (pos + 1 < element_subpaths.length) {
				items.push(
					React.createElement("li", {key: pos}, 
						...
						React.createElement("a", {href: url_navigate + newpath}, 
		...
		if (items.length > 0) {
			header.push(
				React.createElement("li", {key: "storagestitle"}, 
					React.createElement("a", {href: url_navigate}, 
						i18n('browser.storagestitle')
					), 
					React.createElement("span", {className: "divider"}, "::")
				)
			...
			if (path != "/") {
				header.push(
					React.createElement("li", {key: "root"}, 
						React.createElement("a", {href: url_navigate + storagename + ':/'}, 
							storagename
						)
					)
				);
...
// Source hash: 116da5d62c1eb542c0aae2c8f69786ba
