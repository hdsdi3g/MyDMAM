...
pathindex.reactSinceDate = React.createClass({displayName: "reactSinceDate",
	render: function() {
		...
		return (React.createElement("span", {className: "label", style: style}, 
			React.createElement("i", {className: "icon-time icon-white", style: {marginTop: 0}}), " ", label, mydmam.format.secondsToYWDHMS(since)
		));
	},
});
...
// Source hash: 3edd3e447a915eb64a97c7ea6c447344
