	...
	render: function() {
		...
		return (
			React.createElement("div", {style: {marginBottom: "1em"}}, 
				React.createElement(metadatas.Mediaplayer, {
				...
				React.createElement(metadatas.Image, {file_hash: file_hash, previews: previews, hide_audio_da_grahic: true, prefered_size: "cartridge_thumbnail"})
			)
		);
	}
});
...
// Source hash: e31db89e260cddee1e2596764b03d23b
