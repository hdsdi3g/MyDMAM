...
}});a.makeGitHubLink=function(b,d){if(d==null){return null;}if(b==null|((d.indexOf("hd3gtv.")!=0)&(d.indexOf("controllers.")!=0))){return null;
}var c=d.indexOf("$");if(c>-1){d=d.substring(0,c);}return"https://github.com/hdsdi3g/MyDMAM/blob/"+b.substring(b.lastIndexOf(" ")+1)+"/app/"+d.replace(/\./g,"/")+".java";
};a.JavaClassNameLink=React.createClass({displayName:"JavaClassNameLink",onClickLink:function(b){b.stopPropagation();
},render:function(){var e=this.props.javaclass;if(e==null){return(React.createElement("strong",null,React.createElement("em",{className:"muted"},"Void")));
}var c=this.props.version;var d=a.makeGitHubLink(c,e);if(d==null){return(React.createElement("span",null,e));
}var b={height:14,lineHeight:14,marginTop:1,verticalAlign:"text-top",width:14};return(React.createElement("span",null,React.createElement("a",{href:d,target:"_blank",onClick:this.onClickLink},React.createElement("img",{src:mydmam.urlimgs.github_favicon,style:b})," ",React.createElement("abbr",{title:e},e.substring(e.lastIndexOf(".")+1)))));
...
}else{if(f.file){var c=a.makeGitHubLink(this.props.version,f["class"]);if(f.line>=0){if(c){b.push(React.createElement("div",{key:d++}," at ",f["class"],".",f.method,"(",React.createElement("a",{href:c+"#L"+f.line,target:"_blank"},f.file,":",f.line),")"));
