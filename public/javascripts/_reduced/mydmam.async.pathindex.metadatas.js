...
},onChooseAudioStatBlock:function(e){this.setState({show_audio_stat_channel:e});},render:function(){var n=(React.createElement("span",null,"-∞"));
var v=n;var u=n;var f=n;var e=n;var t=n;var q=n;var s=n;var r={color:"#777"};var k={color:"#777"};
if(this.state.analyst_result!=null){v=this.state.analyst_result.integrated_loudness;
u=this.state.analyst_result.integrated_loudness_threshold;f=this.state.analyst_result.loudness_range_LRA;
e=this.state.analyst_result.loudness_range_threshold;t=this.state.analyst_result.loudness_range_LRA_low;
q=this.state.analyst_result.loudness_range_LRA_high;s=this.state.analyst_result.true_peak;
if((v-2)>this.props.lufs_ref){r={color:"#F00"};}else{if((v+2)<this.props.lufs_ref){r={color:"#F0F"};
}else{r={color:"#0F0"};}}if(s>this.props.truepeak_ref){k={color:"#F00"};}else{k={color:"#0F0"};
}}var p="+";var j=null;if(this.state.show_bottom_panel&(this.state.analyst_result!=null)){p="-";
var i=null;if(this.state.analyst_result.silences){i=(React.createElement("p",null,"Silences to show !"));
}var o=[];o.push(React.createElement(d.ButtonChooseAudioStatBlock,{selected:this.state.show_audio_stat_channel=="Overall",key:0,channel:"Overall",onChooseAudioStatBlock:this.onChooseAudioStatBlock}));
for(var h in this.state.analyst_result.channels_stat){var m=h;o.push(React.createElement("span",{key:h+1},React.createElement(d.ButtonChooseAudioStatBlock,{channel:m,selected:this.state.show_audio_stat_channel==m,onChooseAudioStatBlock:this.onChooseAudioStatBlock})));
}var l=null;var g=function(w){var x=""+w.dc_offset;if(w.dc_offset>=0){x="+"+x;}return(React.createElement("div",{style:{marginLeft:"6px"}},React.createElement("div",null,"DC Offset: ",React.createElement("strong",{style:{color:"rgb(212, 228, 166)"}},x)),React.createElement("div",null,"Level: min ",React.createElement("strong",{style:{color:"rgb(106, 127, 138)"}},w.min_level),", max ",React.createElement("strong",{style:{color:"rgb(106, 127, 138)"}},w.max_level)),React.createElement("div",null,"Difference: min ",React.createElement("strong",{style:{color:"rgb(121, 141, 147)"}},w.min_difference),", max ",React.createElement("strong",{style:{color:"rgb(121, 141, 147)"}},w.max_difference),", mean ",React.createElement("strong",{style:{color:"rgb(121, 141, 147)"}},w.mean_difference)),React.createElement("div",null,"Peak level: ",React.createElement("strong",{style:{color:"rgb(247, 165, 87)"}},w.peak_level.toFixed(2))," dBFS, count: ",React.createElement("strong",{style:{color:"rgb(247, 165, 87)"}},w.peak_count)),React.createElement("div",null,"RMS (dBFS): level ",React.createElement("strong",{style:{color:"rgb(167,121,80)"}},w.rms_level.toFixed(2)),", peak ",React.createElement("strong",{style:{color:"rgb(167,121,80)"}},w.rms_peak.toFixed(2)),", trough ",React.createElement("strong",{style:{color:"rgb(167,121,80)"}},w.rms_trough.toFixed(2))),React.createElement("div",null,"Crest factor: ",React.createElement("strong",{style:{color:"rgb(78,105,137)"}},w.crest_factor.toFixed(2)),", flat factor: ",React.createElement("strong",{style:{color:"rgb(78,105,137)"}},w.flat_factor.toFixed(2)))));
};if(this.state.show_audio_stat_channel=="Overall"){l=g(this.state.analyst_result.overall_stat);
}else{for(var h in this.state.analyst_result.channels_stat){var m=h;if(this.state.show_audio_stat_channel==m){l=g(this.state.analyst_result.channels_stat[h]);
break;}}}j=(React.createElement("div",{style:{padding:12,backgroundColor:"#333",color:"#887",fontFamily:"Tahoma, Arial",width:"300pt"}},i,React.createElement("div",{style:{marginBottom:"6px"}},o),l,React.createElement("span",{style:{fontWeight:"bold",color:"rgb(92,200,90)"}},this.state.analyst_result.number_of_samples)," samples"));
}return(React.createElement("div",{className:"clearfix",style:{margin:"1em"}},React.createElement("div",{style:{padding:"12px 12px 7px",backgroundColor:"#333",color:"#fff",fontFamily:"Tahoma, Arial",width:"300pt",fontWeight:"bold"}},React.createElement("div",{style:{left:"0px",top:"12px",position:"relative","float":"left",fontSize:"56px"}},React.createElement("span",{style:r},v)),React.createElement("div",{style:{left:"0px",top:"0px",position:"relative","float":"left",fontSize:"16px",color:"#666"}}," LUFS"),React.createElement("div",{style:{left:"18px",top:"22px",position:"relative","float":"left",fontSize:"28px"}},React.createElement("span",{style:k},s)),React.createElement("div",{style:{left:"-30px",top:"0px",position:"relative","float":"left",fontSize:"16px",color:"#666"}}," dB TPK"),React.createElement("div",{style:{left:"-5px",top:"0px",position:"relative","float":"left",lineHeight:"15px",color:"rgb(148, 104, 83)"}},React.createElement("span",{style:{fontWeight:"normal"}},"High"),React.createElement("br",null),React.createElement("span",null,"LRA"),React.createElement("br",null),React.createElement("span",{style:{fontWeight:"normal"}},"Low")),React.createElement("div",{style:{left:"5px",top:"0px",position:"relative","float":"left",lineHeight:"15px",color:"rgb(187, 109, 71)"}},React.createElement("span",null,q),React.createElement("br",null),React.createElement("span",null,"Δ ",f),React.createElement("br",null),React.createElement("span",null,t)),React.createElement("br",{style:{"float":"clear"}}),React.createElement("div",{style:{left:"0px",top:"5px",marginTop:"33px",fontWeight:"normal",lineHeight:"20px",color:"rgb(84, 114, 148)"}},"Thresholds / integrated loudness: ",React.createElement("span",{style:{fontWeight:"bold"}},u)," • range: ",React.createElement("span",{style:{fontWeight:"bold"}},e),React.createElement("span",{style:{"float":"right",padding:"0px 6px 3px 7px",border:"1px solid #888",color:"#888",marginTop:"2px",marginRight:"-12px",marginBottom:"0px",cursor:"pointer",width:"11px",textAlign:"center"},onClick:this.toogleBottomPanel},p))),j));
