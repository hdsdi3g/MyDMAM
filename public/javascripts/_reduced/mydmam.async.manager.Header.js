...
}}}}}}}return(React.createElement(mydmam.async.PageHeaderTitle,{title:i18n("manager.pagename"),fluid:"true"},React.createElement("ul",{className:"nav nav-tabs"},React.createElement(mydmam.async.HeaderTab,{href:"#manager/summary",i18nlabel:"manager.summaries"}),React.createElement(mydmam.async.HeaderTab,{href:"#manager/items",i18nlabel:"manager.items"}),React.createElement(mydmam.async.HeaderTab,{href:"#manager/pendingactions",i18nlabel:"manager.pendingactions"}),React.createElement(mydmam.async.HeaderTab,{href:"#manager/lastjobs",i18nlabel:"manager.lastjobs"}),React.createElement(mydmam.async.HeaderTab,{href:"#manager/threads",i18nlabel:"manager.threads"}),React.createElement(mydmam.async.HeaderTab,{href:"#manager/perfstats",i18nlabel:"manager.perfstats"}),React.createElement(mydmam.async.HeaderTab,{href:"#manager/classpath",i18nlabel:"manager.classpath"}),React.createElement("li",{className:"pull-right"},React.createElement("a",{href:location.hash,onClick:this.truncateDb},i18n("manager.truncate")))),b));
