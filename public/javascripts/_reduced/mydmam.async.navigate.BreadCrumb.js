...
if(h+1<i.length){g.push(React.createElement("li",{key:h},React.createElement("span",{className:"divider"},"/"),React.createElement("a",{href:e+b},i[h])));
}else{g.push(React.createElement("li",{key:h,className:"active"},React.createElement("span",{className:"divider"},"/"),i[h]));
}d=d+"/"+i[h];}var c=[];if(g.length>0){c.push(React.createElement("li",{key:"storagestitle"},React.createElement("a",{href:e},i18n("browser.storagestitle")),React.createElement("span",{className:"divider"},"::")));
if(j!="/"){c.push(React.createElement("li",{key:"root"},React.createElement("a",{href:e+f+":/"},f)));
