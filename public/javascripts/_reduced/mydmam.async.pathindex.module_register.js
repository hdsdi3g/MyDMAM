...
}if(d){return false;}if(window.list_external_positions_storages==null){return false;
}for(var f=0;f<list_external_positions_storages.length;f++){if(list_external_positions_storages[f]===e){return true;
