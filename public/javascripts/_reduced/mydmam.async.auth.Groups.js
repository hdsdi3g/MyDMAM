...
}return(React.createElement(mydmam.async.PageHeaderTitle,{title:i18n("auth.groupedit",this.state.group_name),fluid:"false"},React.createElement("form",{className:"form-horizontal",onSubmit:this.onEditBtnClick},React.createElement(h,{label:i18n("auth.remove-label")},React.createElement("a",{className:"btn btn-danger",onClick:this.onDeleteBtnClick},React.createElement("i",{className:"icon-remove icon-white"})," ",i18n("auth.remove"))),React.createElement(h,{label:i18n("auth.roles")},c),React.createElement(h,null,React.createElement("button",{type:"submit",className:"btn btn-success"},React.createElement("i",{className:"icon-ok icon-white"})," ",i18n("auth.save"))),React.createElement(h,null,React.createElement("a",{type:"cancel",className:"btn btn-info",href:"#auth/groups"},React.createElement("i",{className:"icon-chevron-left icon-white"})," ",i18n("auth.goback"))))));
