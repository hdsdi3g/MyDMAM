...
k.push(React.createElement("div",{style:{marginTop:5},key:"deltadate"},React.createElement("span",{className:"label",style:{marginLeft:5}},React.createElement("i",{className:"icon-time icon-white"}),i18n("manager.jobs.secs",(g.end_date-g.start_date)/1000))));
...
var v=null;var f=JSON.stringify(g.context.content,null," ");if(f!="{}"){v=(React.createElement("code",{className:"json",onClick:this.onClickDoNothing},React.createElement("i",{className:"icon-indent-left"}),React.createElement("span",{className:"jsontitle"}," ",i18n("manager.jobs.context")),f));
}var b=null;if(g.context.neededstorages){var h="manager.jobs.targetstorage";if(g.context.neededstorages.length>1){h="manager.jobs.targetstorages";
}b=(React.createElement("span",null,i18n(h)," ",React.createElement("span",{className:"badge badge-warning"},React.createElement("i",{className:"icon-hdd icon-white"})," ",g.context.neededstorages.join(", "))));
}var r=null;if(g.context.hookednames){var h="manager.jobs.hookedname";if(g.context.hookednames.length>1){h="manager.jobs.hookednames";
}r=(React.createElement("span",null,i18n(h)," ",React.createElement("span",{className:"badge badge-inverse"},React.createElement("i",{className:"icon-tags icon-white"})," ",g.context.hookednames.join(", "))));
}c=(React.createElement("div",{style:{marginBottom:7}},React.createElement("div",{style:{marginTop:5}},i18n("manager.jobs.contextclass")," ",React.createElement(mydmam.async.JavaClassNameLink,{javaclass:g.context.classname,version:this.props.version})),React.createElement("div",{style:{marginTop:5}},b),React.createElement("div",{style:{marginTop:5}},r),React.createElement("div",{style:{marginTop:7}},v)));
var l=(React.createElement("div",{style:{marginTop:5}},i18n("manager.jobs.jref")," ",React.createElement("span",null,a.displayKey(g.key,true))));
if(g.worker_reference!=null&g.worker_class!=null){n=(React.createElement("div",{className:"span7"},React.createElement("div",{style:{marginTop:5}},i18n("manager.jobs.wref")," ",React.createElement("span",null,a.displayKey(g.worker_reference,true))),React.createElement("div",{style:{marginTop:5}},i18n("manager.jobs.classexec")," ",React.createElement(mydmam.async.JavaClassNameLink,{javaclass:g.worker_class,version:this.props.version})),l));
