...
}else{b.push(React.createElement("span",{key:c,className:"badge badge-warning",style:{marginLeft:8}},React.createElement("i",{className:"icon-hdd icon-white"})," ",e.neededstorages[c]));
}}i=(React.createElement("span",null,i18n(j),b));}var k=null;if(e.hookednames){var j="manager.jobs.hookedname";
if(e.hookednames.length>1){j="manager.jobs.hookednames";}var g=[];for(var h in e.hookednames){if(e.hookednames.length>1){g.push(React.createElement("div",{key:h},React.createElement("span",{className:"badge badge-inverse",style:{marginLeft:8}},React.createElement("i",{className:"icon-tags icon-white"})," ",e.hookednames[h])));
}else{g.push(React.createElement("span",{key:h,className:"badge badge-inverse",style:{marginLeft:8}},React.createElement("i",{className:"icon-tags icon-white"})," ",e.hookednames[h]));
